...
const massageCrate = document.getElementById("message-create");
/* time elements */
...
Hello
<div class="todo-icons">
  <span class="opacity-50 me-2">12.02.2023</span>
...
formCreate.addEventListener("submit", (e) => {
  ...
  if (todoText.length) {
    ...
    showMassage("message-create", "Iltimos biror narsa yozing...");
  }
});
...
formEdit.addEventListener("submit", (e) => {
  ...
  if (todoText.length) {
    ...
    showMassage("message-edit", "Iltimos biror narsa yozing...");
  }
});
